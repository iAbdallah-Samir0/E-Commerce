                                ...
                                <div class="row">
                                    <div class="col-lg-2">
                                        <div class="details-image-vertical black-slide rounded">
                                            ...
                                            @if($product->images)
                                                @php
                                                    $images = explode(',',$product->images);         // Regarding the pictures next to it
                                                @endphp
                                    ...
                                    <div class="col-lg-10">
                                        <div class="details-image-1 ratio_asos">
                                            ...
                                            {{--                                            @if($product->images)--}}
                                            {{--                                                @php--}}
                                            {{--                                                    $images = explode(',',$product->images);       // Regarding the main image--}}
                                            {{--                                                @endphp--}}
                                            {{--                                                @foreach ($images as $image)--}}
                                            {{--                                                    <div>--}}
                            ...
                            <div class="col-md-6">
                                <div class="cloth-details-size">
                                    ...
                                    <div class="product-buttons">
                                        ...
                                        <a href="{{ route('cart.store') }}"  onclick="event.preventDefault();document.getElementById('Add To Cart').submit();" id="cartEffect" class="btn btn-solid hover-solid btn-animation">
                                        ...
                                        <div class="front">
                                            <a href="{{route('shop.product.details',['slug'=>$rproduct->slug])}}">
                                                <img src="{{asset('assets/images/fashion/product/front')}}/{{$rproduct->image}}"
                                                     class="bg-img blur-up lazyload" alt="{{$rproduct->name}}">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="{{route('shop.product.details',['slug'=>$rproduct->slug])}}">
