            ...
            <div class="container">
                <form action="{{ route('admin.admins.update' , $admin) }}" method="post">
                    ...
                    <div class="px-2 py-1">
                        ...
                        <input id="name" type="text" name="name" class="form-control" required value="{{ old('name') ?? $admin->name }}">
                    </div>
                    ...
                    <div class="px-2 py-1">
                        ...
                        <input id="email" type="email"
                               ...
                               required autocomplete="email" value="{{ old('email') ?? $admin->email }}">
                    </div>
                    ...
                    <div class="px-2 py-1">
                        ...
                        <input id="password" type="password"
                               ...
                               required value="{{ old('password') ?? $admin->password }}">
                    </div>
