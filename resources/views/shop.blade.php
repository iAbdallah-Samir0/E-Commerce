...
{{--                                                <li>--}}
{{--                                                <a href="{{ route('wishlist.store') }}" onclick="event.preventDefault(); submitWishlistForm({{ $product->id }});" id="cartEffect" class="btn btn-solid hover-solid btn-animation">--}}
{{--                                                    <i data-feather="heart"></i>--}}
{{--                                                    <form id="add-to-wishlist-{{ $product->id }}" action="{{ route('wishlist.store') }}" method="POST" style="display: none;">--}}
{{--                                                        @csrf--}}
{{--                                                        <input type="hidden" name="id" value="{{ $product->id }}">--}}
{{--                                                        <input type="hidden" name="quantity" id="qty" value="1">--}}
{{--                                                    </form>--}}
...
@endsection
    ...
    @push('scripts')
        <script>
            ...
            //     document.getElementById('add-to-wishlist-' + productId).submit();
            // }
